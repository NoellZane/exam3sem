...
return(
    ...
    <li><NavLink activeClassName="selected" to="/fetch/sequential">Fetch Sequential</NavLink></li>
    <li><NavLink activeClassName="selected" to="/fetch/parallel">Fetch Parallel</NavLink></li>
